"""Base Django settings for the participation-service."""
...
SERVICE_NAME = "participation-service"
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Event registration and check-in service for the Sansaar platform.",
    "VERSION": "1.0.0",
